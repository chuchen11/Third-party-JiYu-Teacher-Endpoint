...
const logMessages = [
  ...
  "[RemoteView] TCP connected 192.168.2.139:4806",
  "[RemoteView] SHCO sent, UMSP channel=10",
  "[RemoteView] TKPC/HHRF H.264 frame decoded",
  "[RemoteView] SPUC cursor record received",
  "[RemoteControl] COMD -> MCMD mode=2 ready",
  "[RemoteControl] mouse move packet sent",
  "[RemoteControl] mouse button packet sent",
  "[RemoteControl] kind=16 sent (experimental)",
